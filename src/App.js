        ...
        <BrowserRouter>
          ...
          <div>
            <Routes>
              ...
              <Route exact path="/" element={<News setProgress={this.setProgress} key='general' pageSize={this.pageSize} country='in' />}></Route>
...
// to every <News setprogress={this.setProgress}> component, we need to pass a unique key parameter so that each time we hit our end points the complete components get re rendered with the updated props value. Otherwise this wont work and we will see the same page on our each endpoint